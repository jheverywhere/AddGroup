 ...
 */
// $config['base_url'] = 'http://imissu.webist.co.kr/';
 ...
 */
$config['encryption_key'] = 'a002a26dfc93';
...
// REST 플러그인
$config['csrf_exclude_uris'][] = 'api/auth/login'; // 인증
$config['csrf_exclude_uris'][] = 'api/auth/autologin'; // 자동로그인
$config['csrf_exclude_uris'][] = 'api/upload/do_upload';
$config['csrf_exclude_uris'][] = 'api/trans/upload';
$config['csrf_exclude_uris'][] = 'api/etas/upd_result';

$config['csrf_exclude_uris'][] = "members/.*+";
$config['csrf_exclude_uris'][] = "contract/.*+";
$config['csrf_exclude_uris'][] = "settings/.*+";
