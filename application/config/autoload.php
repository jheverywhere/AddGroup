 ...
 */
$autoload['libraries'] = array('session', 'managelayout', 'member', 'cbconfig', 'board', 'user_agent', 'events', 'format');
 ...
 */
$autoload['helper'] = array('url', 'basic', 'thumbnail', 'cookie', 'debug', 'jwt', 'authorization');
 ...
 */
$autoload['config'] = array('cb_config', 'cb_version', 'jwt');
