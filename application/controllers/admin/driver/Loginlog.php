...
class Loginlog extends CB_Controller
{
	 ...
	 * 페이지 이동시 필요한 정보입니다
	 */
	public $pagedir = 'driver/loginlog';
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_loginlog_index';
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_loginlog_graph';
		$this->load->event($eventname);
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_loginlog_graph_fail';
		$this->load->event($eventname);
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_loginlog_listdelete';
		$this->load->event($eventname);
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_loginlog_cleanlog';
		$this->load->event($eventname);
