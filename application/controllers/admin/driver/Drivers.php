 ...
 */
class Drivers extends CB_Controller
{
	 ...
	 * 헬퍼를 로딩합니다
	 */
	protected $helpers = array('form', 'array', 'chkstring', 'string');
	...
	public function index()
	{
		...
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_drivers_index';
        ...
        $view['view']['all_group'] = $this->Member_group_model->get_all_driver_group();
	...
	public function write($pid = 0)
	{
		...
		$getdata['mgroup'] = $this->Member_group_model->get_all_driver_group();
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_drivers_socialinfo';
		$this->load->event($eventname);
	...
	public function excel()
	{
		...
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_driver_drivers_excel';
		$this->load->event($eventname);
