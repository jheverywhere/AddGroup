...
class Google_Service_AndroidPublisher extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->inapproducts = new Google_Service_AndroidPublisher_Inapproducts_Resource(
        $this,
        $this->serviceName,
        'inapproducts',
        array(
          'methods' => array(
            'batch' => array(
              'path' => 'inapproducts/batch',
              'httpMethod' => 'POST',
              'parameters' => array(),
            ),'delete' => array(
              'path' => '{packageName}/inapproducts/{sku}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'packageName' => array(
                  'location' => 'path',
...
/**
 * The "inapproducts" collection of methods.
 * Typical usage is:
 *  <code>
 *   $androidpublisherService = new Google_Service_AndroidPublisher(...);
 *   $inapproducts = $androidpublisherService->inapproducts;
 *  </code>
 */
class Google_Service_AndroidPublisher_Inapproducts_Resource extends Google_Service_Resource
{

  /**
   * (inapproducts.batch)
   *
   * @param Google_InapproductsBatchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_AndroidPublisher_InapproductsBatchResponse
   */
  public function batch(Google_Service_AndroidPublisher_InapproductsBatchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('batch', array($params), "Google_Service_AndroidPublisher_InapproductsBatchResponse");
  }

  /**
   * Delete an in-app product for an app. (inapproducts.delete)
   *
  ...
  /**
   * Returns information about the in-app product specified. (inapproducts.get)
   *
   * @param string $packageName
   * @param string $sku Unique identifier for the in-app product.
   * @param array $optParams Optional parameters.
   * @return Google_Service_AndroidPublisher_InApproduct
   */
  public function get($packageName, $sku, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'sku' => $sku);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_AndroidPublisher_InApproduct");
  }

  /**
   * Creates a new in-app product for an app. (inapproducts.insert)
   *
   * @param string $packageName Unique identifier for the Android app; for
   * example, "com.spiffygame".
   * @param Google_InApproduct $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_AndroidPublisher_InApproduct
   */
  public function insert($packageName, Google_Service_AndroidPublisher_InApproduct $postBody, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Google_Service_AndroidPublisher_InApproduct");
  }

  /**
   * List all the in-app products for an Android app, both subscriptions and
   * managed in-app products.. (inapproducts.listInapproducts)
   *
   ...
   * @opt_param string startIndex
   * @opt_param string maxResults
   * @return Google_Service_AndroidPublisher_InapproductsListResponse
   */
  public function listInapproducts($packageName, $optParams = array())
  {
    $params = array('packageName' => $packageName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_AndroidPublisher_InapproductsListResponse");
  }

  /**
   * Updates the details of an in-app product. This method supports patch
   * semantics. (inapproducts.patch)
   *
   * @param string $packageName Unique identifier for the Android app with the in-
   * app product; for example, "com.spiffygame".
   * @param string $sku Unique identifier for the in-app product.
   ...
   * @return Google_Service_AndroidPublisher_InApproduct
   */
  public function patch($packageName, $sku, Google_Service_AndroidPublisher_InApproduct $postBody, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'sku' => $sku, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_AndroidPublisher_InApproduct");
  }

  /**
   * Updates the details of an in-app product. (inapproducts.update)
   *
   * @param string $packageName Unique identifier for the Android app with the in-
   * app product; for example, "com.spiffygame".
   * @param string $sku Unique identifier for the in-app product.
   ...
   * @return Google_Service_AndroidPublisher_InApproduct
   */
  public function update($packageName, $sku, Google_Service_AndroidPublisher_InApproduct $postBody, $optParams = array())
  {
    $params = array('packageName' => $packageName, 'sku' => $sku, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Google_Service_AndroidPublisher_InApproduct");
  }
}
...
class Google_Service_AndroidPublisher_InApproduct extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $defaultLanguage;
  ...
  protected $listingsType = 'Google_Service_AndroidPublisher_InApproductListing';
...
class Google_Service_AndroidPublisher_InApproductListing extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Google_Service_AndroidPublisher_InApproductListings extends Google_Model
{
}

class Google_Service_AndroidPublisher_InApproductPrices extends Google_Model
{
}

class Google_Service_AndroidPublisher_InapproductsBatchRequest extends Google_Collection
{
  protected $collection_key = 'entrys';
  protected $internal_gapi_mappings = array(
  );
  protected $entrysType = 'Google_Service_AndroidPublisher_InapproductsBatchRequestEntry';
...
class Google_Service_AndroidPublisher_InapproductsBatchRequestEntry extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $batchId;
  protected $inapproductsinsertrequestType = 'Google_Service_AndroidPublisher_InapproductsInsertRequest';
  protected $inapproductsinsertrequestDataType = '';
  protected $inapproductsupdaterequestType = 'Google_Service_AndroidPublisher_InapproductsUpdateRequest';
  protected $inapproductsupdaterequestDataType = '';
  public $methodName;
  ...
  public function setInapproductsinsertrequest(Google_Service_AndroidPublisher_InapproductsInsertRequest $inapproductsinsertrequest)
  {
    $this->inapproductsinsertrequest = $inapproductsinsertrequest;
  }
  public function getInapproductsinsertrequest()
  {
    return $this->inapproductsinsertrequest;
  }
  public function setInapproductsupdaterequest(Google_Service_AndroidPublisher_InapproductsUpdateRequest $inapproductsupdaterequest)
  {
    $this->inapproductsupdaterequest = $inapproductsupdaterequest;
  }
  public function getInapproductsupdaterequest()
  {
    return $this->inapproductsupdaterequest;
  }
...
class Google_Service_AndroidPublisher_InapproductsBatchResponse extends Google_Collection
{
  protected $collection_key = 'entrys';
  protected $internal_gapi_mappings = array(
  );
  protected $entrysType = 'Google_Service_AndroidPublisher_InapproductsBatchResponseEntry';
  protected $entrysDataType = 'array';
  public $kind;
...
class Google_Service_AndroidPublisher_InapproductsBatchResponseEntry extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $batchId;
  protected $inapproductsinsertresponseType = 'Google_Service_AndroidPublisher_InapproductsInsertResponse';
  protected $inapproductsinsertresponseDataType = '';
  protected $inapproductsupdateresponseType = 'Google_Service_AndroidPublisher_InapproductsUpdateResponse';
  protected $inapproductsupdateresponseDataType = '';
  ...
  public function setInapproductsinsertresponse(Google_Service_AndroidPublisher_InapproductsInsertResponse $inapproductsinsertresponse)
  {
    $this->inapproductsinsertresponse = $inapproductsinsertresponse;
  }
  public function getInapproductsinsertresponse()
  {
    return $this->inapproductsinsertresponse;
  }
  public function setInapproductsupdateresponse(Google_Service_AndroidPublisher_InapproductsUpdateResponse $inapproductsupdateresponse)
  {
    $this->inapproductsupdateresponse = $inapproductsupdateresponse;
  }
  public function getInapproductsupdateresponse()
  {
    return $this->inapproductsupdateresponse;
  }
}

class Google_Service_AndroidPublisher_InapproductsInsertRequest extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $inapproductType = 'Google_Service_AndroidPublisher_InApproduct';
  protected $inapproductDataType = '';


  public function setInapproduct(Google_Service_AndroidPublisher_InApproduct $inapproduct)
  {
    $this->inapproduct = $inapproduct;
  }
  public function getInapproduct()
  {
    return $this->inapproduct;
  }
}

class Google_Service_AndroidPublisher_InapproductsInsertResponse extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $inapproductType = 'Google_Service_AndroidPublisher_InApproduct';
...
class Google_Service_AndroidPublisher_InapproductsListResponse extends Google_Collection
{
  protected $collection_key = 'inapproduct';
  protected $internal_gapi_mappings = array(
  );
  protected $inapproductType = 'Google_Service_AndroidPublisher_InApproduct';
  protected $inapproductDataType = 'array';
  public $kind;
  protected $pageInfoType = 'Google_Service_AndroidPublisher_PageInfo';
  protected $pageInfoDataType = '';
  protected $tokenPaginationType = 'Google_Service_AndroidPublisher_TokenPagination';
  ...
  public function setInapproduct($inapproduct)
  {
    $this->inapproduct = $inapproduct;
  }
  public function getInapproduct()
...
class Google_Service_AndroidPublisher_InapproductsUpdateRequest extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $inapproductType = 'Google_Service_AndroidPublisher_InApproduct';
...
class Google_Service_AndroidPublisher_InapproductsUpdateResponse extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $inapproductType = 'Google_Service_AndroidPublisher_InApproduct';
