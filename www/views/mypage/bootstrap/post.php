...
<div class="mypage">
	...
	<div class="btn-group btn-group-justified mb20" role="group" aria-label="...">
		<div class="btn-group" role="group"><a href="<?php echo site_url('mypage/post'); ?>" class="btn btn-warning btn-sm" title="원글">원글</a></div>
		<div class="btn-group" role="group"><a href="<?php echo site_url('mypage/comment'); ?>" class="btn btn-success btn-sm" title="댓글">댓글</a></div>
	</div>
