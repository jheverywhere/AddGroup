...
<div class="mypage">
	...
	<div class="btn-group btn-group-justified mb20" role="group" aria-label="...">
		...
		<div class="btn-group" role="group">
			<a href="<?php echo site_url('mypage/followedlist'); ?>" class="btn btn-success btn-sm" title="Followed">Followed (<?php echo number_format(element('followed_total_rows', $view)); ?>)</a>
		</div>
	</div>
