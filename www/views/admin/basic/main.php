		...
		<table class="table table-hover table-striped">
			...
			?>
				<tr>
					...
					<td><?php echo element('mem_username', $value); ?></td>
...
<div class="col-sm-6">
	<div class="panel panel-default">
		<!-- Default panel contents -->
		<div class="panel-heading">차량등록현황
			<div class="view-all">
...
<div class="col-sm-6">
	<div class="panel panel-default">
		<!-- Default panel contents -->
		<div class="panel-heading">주간 사용현황
			<div class="view-all">
...
<div class="col-sm-6">
	<div class="panel panel-default">
		<!-- Default panel contents -->
		<div class="panel-heading">월간 사용현황
			<div class="view-all">
...
<div class="col-sm-6">
	<div class="panel panel-default">
		<!-- Default panel contents -->
		<div class="panel-heading">최근 장애내역
			<div class="view-all">
				<!-- <a href="<?php echo admin_url('board/post'); ?>">More <i class="fa fa-angle-right"></i></a> -->
			</div>
		</div>
