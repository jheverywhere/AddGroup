		...
		?>
			<div class="box-table-header">
				<div class="btn-group btn-group-sm" role="group">
					<a href="?" class="btn btn-sm <?php echo ( ! $this->input->get('mem_is_admin') && ! $this->input->get('mem_denied')) ? 'btn-success' : 'btn-default'; ?>">전체기사</a>
					<!-- <a href="?mem_is_admin=1" class="btn btn-sm <?php echo ($this->input->get('mem_is_admin')) ? 'btn-success' : 'btn-default'; ?>">최고관리자</a> -->
					<a href="?mem_denied=1" class="btn btn-sm <?php echo ($this->input->get('mem_denied')) ? 'btn-success' : 'btn-default'; ?>">차단기사</a>
				</div>
				<div class="btn-group btn-group-sm" role="group">
				...
				?>
					<div class="btn-group pull-right" role="group" aria-label="...">
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger btn-sm">기사추가</a>
					</div>
				<?php
				...
				<table class="table table-hover table-striped table-bordered">
					<thead>
						<tr>
							...
							<th><a href="<?php echo element('mem_username', element('sort', $view)); ?>">이름</a></th>
							...
							<th>기사그룹</th>
							<th><a href="<?php echo element('mem_level', element('sort', $view)); ?>">기사레벨</a></th>
