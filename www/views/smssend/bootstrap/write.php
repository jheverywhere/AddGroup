	...
	<div class="col-md-12">
		...
		<div class="box-table">
			<div>
				...
				<h5>보낼내용</h5>
				<div>
					<textarea class="form-control" rows="5" name="sfa_content" id="sfa_content" onkeyup="byte_check('sfa_content', 'sms_bytes');"><?php echo set_value('sfa_content', element('sfa_content', element('data', $view))); ?></textarea>
				...
				<div class="form-group form-inline">
					<label for="ssc_send_phone">발신</label>
				...
				<button type="submit" class="btn btn-primary btn-sm btn-block">전송하기</button>
				<?php echo form_close(); ?>
			</div>
		</div>
	</div>
