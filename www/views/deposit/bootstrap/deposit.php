			...
			<table class="table table-striped table-bordered table-hover mt10">
				<tbody>
					<tr>
						...
						<td class="form-inline"><input type="text" name="mem_realname" class="form-control" value="<?php echo $this->member->item('mem_username'); ?>" /></td>
					</tr>
					<tr>
						<td class="text-center">이메일</td>
						<td><input type="email" name="mem_email" class="form-control" value="<?php echo $this->member->item('mem_email'); ?>" /></td>
					</tr>
					<tr>
						<td class="text-center">휴대폰</td>
						<td class="form-inline"><input type="text" name="mem_phone" class="form-control" value="<?php echo $this->member->item('mem_phone'); ?>" /></td>
					</tr>
				</tbody>
			</table>
			<div class="credit_form">
				<label class="radio-inline bold">결제방법</label>
