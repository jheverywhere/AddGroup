		...
		<div class="panel-body">
			...
			echo form_open_multipart(current_full_url(), $attributes);
				foreach (element('html_content', $view) as $key => $value) {
                    if ($value['field_name'] == 'mem_nickname') {
                        echo element('input', $value);
                    } else {
                ?>
					<div class="form-group<?=(substr($value['field_name'], 0, 8) == 'mem_biz_' && $value['field_name'] != 'mem_biz_yn') ? " mem_biz" : ""?>">
...
$(function() {
    $("input[name=mem_biz_yn]").click(function () {
